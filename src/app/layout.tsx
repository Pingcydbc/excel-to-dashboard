...
export const metadata: Metadata = {
  title: "วิทยาลัยเทคนิคเชียงใหม่ | ระบบรายงานและวิเคราะห์ข้อมูลนักศึกษา",
  description: "แดชบอร์ดสรุปผลการปรับปรุงข้อมูลนักเรียน นักศึกษา ภาวะการมีงานทำ และสถิติสถานประกอบการ วิทยาลัยเทคนิคเชียงใหม่",
  icons: {
    icon: "/logo.png",
  },
};
